$(document).ready(function() {
   const apiRoot = 'https://kodilla-task-application.herokuapp.com/v1/task/';
   const trelloApiRoot = 'https://kodilla-task-application.herokuapp.com/v1/trello/';
   ...
   function getAllAvailableBoards(callback, callbackArgs) {
      var requestUrl = trelloApiRoot + 'getTrelloBoardse';
